...
test_that("Gb_SJ calculates correctly", {
  ...
  # Example from "Abschätzung der mittleren jährlichen Geschiebelieferung n Vorfluter", S. 57
  result <- Gb_SJ(d30 = d30, dm = dm, d90 = d90, J = J, Rs = Rs, um = um, B = B, tcrit = 0.023)
